...
pimcore.registerNS("pimcore.bundle.advancedSearch.selector");
pimcore.bundle.advancedSearch.selector = Class.create({
    ...
    moveToTab: function () {
        ...
        this.tabpanel = new Ext.Panel({
            ...
            title: t("bundle_advancedSearch_open_saved_searches"),
            border: false,
            layout: "fit",
            closable:true,
            items: [this.panel]
    ...
    getResultPanel: function () {
        ...
        this.store = new Ext.data.Store({
            ...
            proxy : {
                type: 'ajax',
                url: '/admin/bundle/advanced-search/admin/find',
                reader: {
                    type: 'json',
                    totalProperty: 'total',
        ...
        if (!this.resultPanel) {
            var columns = [
                ...
                {header: t("bundle_advancedSearch_category"), width: 150, sortable: true, dataIndex: 'category'},
                {header: t("bundle_advancedSearch_owner"), width: 150, sortable: false, dataIndex: 'ownerId', renderer: function (value, metaData, record, rowIndex, colIndex, store) {
