pimcore.registerNS("pimcore.bundle.advancedSearch.searchConfig.conditionAbstractPanel");

pimcore.bundle.advancedSearch.searchConfig.conditionAbstractPanel = Class.create({
