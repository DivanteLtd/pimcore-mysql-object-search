...
pimcore.registerNS("pimcore.bundle.advancedSearch.searchConfig.fieldConditionPanel.datetime");
pimcore.bundle.advancedSearch.searchConfig.fieldConditionPanel.datetime = Class.create(pimcore.bundle.advancedSearch.searchConfig.fieldConditionPanel.numeric, {
        ...
        return Ext.create('Ext.panel.Panel', {
            ...
            items: [
                operatorCombobox,
                {
                    ...
                    layout: 'hbox',
                    fieldLabel: t("bundle_advancedSearch_date"),
                    style: "padding-left: 20px",
    ...
    getFilterValues: function() {
        ...
        if(value) {
            if (this.timefield.getValue()) {
                ...
                dateString = Ext.Date.format(new Date(dateString), 'timestamp');
            }
            else {
                dateString = Ext.Date.format(value, 'timestamp');
            }
        }
