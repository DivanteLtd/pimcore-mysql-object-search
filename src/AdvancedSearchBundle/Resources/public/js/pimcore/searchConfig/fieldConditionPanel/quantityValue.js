...
pimcore.registerNS("pimcore.bundle.advancedSearch.searchConfig.fieldConditionPanel.quantityValue");
pimcore.bundle.advancedSearch.searchConfig.fieldConditionPanel.quantityValue = Class.create(pimcore.bundle.advancedSearch.searchConfig.fieldConditionPanel.numeric, {
    ...
    getConditionPanel: function() {
        ...
        if(this.data.filterEntryData) {
            ...
            unitFieldValue = this.fieldSelectionInformation.context.defaultUnit;
        }
