...
pimcore.registerNS("pimcore.bundle.advancedSearch.searchConfig.resultPanel");
pimcore.bundle.advancedSearch.searchConfig.resultPanel = Class.create(pimcore.object.helpers.gridTabAbstract, {
    ...
    getLayout: function (initialFilter) {
        ...
        if (this.layout == null) {
            ...
            if(!this.portletMode) {
                this.layout.setTitle(t('bundle_advancedSearch_results'));
                this.layout.setIconCls('pimcore_bundle_advancedSearch_grid');
    ...
    createGrid: function (fromConfig, response, settings, save) {
        ...
        var gridHelper = new pimcore.object.helpers.grid(
            this.selectedClass,
            fields,
            "/admin/bundle/advanced-search/admin/grid-proxy?classId=" + this.classId,
            {
    ...
    batchPrepare: function (columnIndex, onlySelected, append) {
        ...
        if (onlySelected) {
            ...
            Ext.Ajax.request({
                url: "/admin/bundle/advanced-search/admin/get-batch-jobs",
                method: "POST",
                params: params,
    ...
    exportPrepare: function () {
        ...
        Ext.Ajax.request({
            url: "/admin/bundle/advanced-search/admin/get-export-jobs",
            params: params,
            method: "POST",
            success: function (response) {
                var rdata = Ext.decode(response.responseText);
    ...
    openColumnConfig: function () {
        ...
        new pimcore.object.helpers.gridConfigDialog(columnConfig, function (data) {
