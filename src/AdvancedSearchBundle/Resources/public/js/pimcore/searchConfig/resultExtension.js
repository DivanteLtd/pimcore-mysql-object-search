...
pimcore.registerNS("pimcore.bundle.advancedSearch.searchConfig.");
pimcore.bundle.advancedSearch.searchConfig.ResultExtension = Class.create({
    initialize: function () {
...
pimcore.bundle.advancedSearch.searchConfig.ResultPanelExtensionBag = Class.create({
